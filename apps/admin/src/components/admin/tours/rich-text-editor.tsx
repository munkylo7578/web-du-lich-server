...
export function RichTextEditor({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-sm focus-within:border-cyan-600 focus-within:ring-3 focus-within:ring-cyan-400/20">
