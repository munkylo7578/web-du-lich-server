...
import {
  Service,
  type ServiceTranslationSnapshot,
...
export async function saveServiceAction(
  ...
  if (!parsed.success)
    return {
      success: false,
      message: 'Vui lòng kiểm tra lại thông tin dịch vụ.',
  ...
  try {
    ...
    const refs = data.existingImages.map((item, index) => ({
